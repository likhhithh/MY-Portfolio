      ...
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            <span className="font-mono text-cyan-400 text-sm tracking-[0.3em] uppercase">01.</span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="relative w-fit mb-10">
              ...
              />
              <div className="relative w-44 h-44 rounded-3xl glass-strong border border-slate-700/40
                              flex items-center justify-center overflow-hidden">
                {about.image ? (
                  <img src={about.image} alt={hero.name} className="w-full h-full object-cover" />
                ) : (
            ...
            >
              ...
              <p className="text-slate-500 pl-4">
                ...
                <span className="text-slate-400">: </span>
                <span className="text-green-400">"{hero.title.split("|")[0].trim()}"</span>,
              </p>
              <p className="text-slate-500 pl-4">
          ...
          >
            <h3 className="font-display font-bold text-slate-200 text-xl mb-2">Quick Highlights</h3>
            ...
            {data.education?.map((edu, i) => (
              ...
              >
                ...
                <p className="font-display font-bold text-slate-100">{edu.degree}</p>
                <p className="font-body text-slate-400 text-sm mt-1">{edu.institution}</p>
